pipeline {
    environment {
      ...
      namespace = "${env.branchname == 'develop' ? 'escolaaberta-dev' : env.branchname == 'homolog' ? 'escolaaberta-hom' : env.branchname == 'homolog-r2' ? 'escolaaberta-hom2' : 'sme-escolaaberta' }"
    }
    ...
    stages {
       ...
       // }
        ...
        stage('Build') {
          ...
          steps {
            script {
              imagename1 = "registry.sme.prefeitura.sp.gov.br/${env.branchname}/escolaaberta-frontend"
                ...
                script{
                    if ( env.branchname == 'main' ||  env.branchname == 'master' ) {
                     ...
                     withCredentials([file(credentialsId: "${kubeconfig}", variable: 'config')]){
                         ...
                         sh "kubectl rollout restart deployment/escolaaberta-frontend -n ${namespace}"
